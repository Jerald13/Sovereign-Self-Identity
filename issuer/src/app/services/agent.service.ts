...
export class AgentService {
  ...
  sendCredentialOffer(payload: any): Observable<any[]> {
    return this.http.post<any[]>('/issue-credential-2.0/send-offer' , payload)
      .pipe(
        switchMap((response: any) => of(response)),
        catchError(this.handleError<any>('sendCredentialOffer', null))
      );
  }
  ...
  sendProofRequest(payload: any): Observable<any> {
    return this.http.post<any>('/present-proof-2.0/send-request', payload)
      .pipe(
        switchMap((response: any) => of(response)),
  ...
  sendProofPresentation(presentationExchangeID: any, payload: any): Observable<any> {
    return this.http.post<any>('/present-proof-2.0/records/' + presentationExchangeID + '/send-presentation', payload)
      .pipe(
        switchMap((response: any) => of(response)),
  ...
  verifyProofpresentation(presentationExchangeID: any): Observable<any> {
    return this.http.post<any>('/present-proof-2.0/records/' + presentationExchangeID + '/verify-presentation', null)
      .pipe(
        switchMap((response: any) => of(response)),
