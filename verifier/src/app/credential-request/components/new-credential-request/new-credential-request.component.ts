...
export class NewCredentialRequestComponent implements OnInit {
  ...
  onSubmit() {
    this.payload = new NewCredentialRequest().addNewAttributeKeyPair(this.schema.attrNames, this.attributeValues, this.connectionID, this.comment, this.employeeName, this.employeeIC);
